            ...
            children: [
              FutureBuilder<MyResponse>(
                  future: weatherRepository.getSimpleWeatherInfo(city) ??
                      weatherRepository.getSimpleWeatherInfo("Samarkand"),
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.hasData) {
                      ...
                      WeatherMainModel weatherMainModel =
                          (snapshot.data as MyResponse).data
                              as WeatherMainModel;
                      return Column(
                        children: [
                          Container(
                                      ...
                                      TextButton(
                                        style: TextButton.styleFrom(
                                            padding: EdgeInsets.symmetric(
                                                vertical: 16.h),
                                            backgroundColor: AppColors.c_2352CB
                                                .withOpacity(0.6),
                                ...
                                Stack(
                                  children: [
                                    SizedBox(
                                      width: 70.w,
                                      child: Text(
                                        (weatherMainModel.mainInMain.temp -
                                                273.15)
                                            .round()
                                            .toString(),
                                        style: Theme.of(context)
